 ...
 * freeze, and the only way out is PortMaster's kill. It was reported that way
 * against a shipped port, whose log shows the draw counter standing still for
 * 128 frames after "Class MainActivity does not have method finish()V."
 *
