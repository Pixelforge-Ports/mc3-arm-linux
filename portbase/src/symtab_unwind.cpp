 ...
 * the guest library is not in that list and never can be: this loader mapped it
...
extern "C" uintptr_t portbase_unwind_find_exidx(uintptr_t pc, int *pcount)
{
...
DynLibFunction symtable_unwind[] = {
    ...
    NO_THUNK("__gnu_Unwind_Find_exidx", (uintptr_t)&portbase_unwind_find_exidx),
#endif
    { NULL, 0 },
};
